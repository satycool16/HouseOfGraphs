...
#SBATCH --job-name="average_degree"
#SBATCH -o %j.out
#SBATCH -e %j.err
...
graph_id=$1
program_name="average_degree"
input_format=$(jq .$program_name.input_format ./invariants.json | tr -d '"')

# executable
./pre_process.sh "$graph_id" "$program_name"
/opt/jdk-17/bin/java -jar ../grinvin-legacy/grinvin-legacy.jar org.grinvin.invariants.AverageDegree <  ../temp/graph_$graph_id.$input_format
